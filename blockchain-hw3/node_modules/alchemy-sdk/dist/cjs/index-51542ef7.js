...
class AlchemyConfig {
    constructor(config) {
        ...
        this.batchRequests = (config === null || config === void 0 ? void 0 : config.batchRequsets) || false;
    }
    /**
    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield Promise.resolve().then(function () { return require('./alchemy-provider-98d88fdb.js'); });
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield Promise.resolve().then(function () { return require('./alchemy-websocket-provider-5f5ad0e8.js'); });
...
//# sourceMappingURL=index-51542ef7.js.map
